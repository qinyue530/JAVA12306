...
//        J12306Util.printlnLeftTicket("2020-01-21", "广州", "怀集");
    ...
    public static void selectTicket1() {
        Go12306.newInstance()
                .initUser("qyinyue530", "qinyue530495973")    // 用户名/密码
                .initBookTicketInfo("2020-01-21", // 乘车日期
                        "沈阳",   // 始发站
                        "通辽",   // 到达站
                        "G8146",    // 列车编号（D2834）。多个使用英文半角逗号分隔。目前暂时只能人工看列车编号啦
                        "O")    // 列车座席。P,M,O,N,4,3,2,1分别代表：商务特等座(P)、一等座(M)、二等座(O)、无座(N)、软卧(4)、硬卧(3)、软座(2)、硬座(1)。
                .run();
    }

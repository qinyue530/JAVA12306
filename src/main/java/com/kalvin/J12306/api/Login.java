...
//        this.session.httpClient.setHeader(new HashMap<String, String>() {{put("User-Agent", userAgent);}});
    ...
    private String fillLogDeviceUrlParams(String url) {
         ...
         */
        final String algID = "m9o7eGTTtx";
        final String hashCode = "17EWqwUGMD5iRnaQRIV5AjTIz6laqMoi1IewWfKaWdE";
        final String EOQP = "49a9fbfe2beb0490836324ceb234fef4";
        final String jp76 = "52d67b2a5aa5e031084733d5006cc664";
        final String q5aJ = "-8";
        final String Oaew = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3970.5 Safari/537.36";
        final String E3gR = "22060fd946a622d7d850c838b25af45c";
